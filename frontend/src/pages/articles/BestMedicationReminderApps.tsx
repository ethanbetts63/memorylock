    ...
    <>
      ...
      >
        <div className="text-lg text-primary-foreground">
          ...
          <p className="mb-6">Where we shine is in the type of reminders that most apps don’t even attempt: those super important, long-term events you can’t afford to forget. Think things like: visa expirations, business license renewals, warranty deadlines, anniversary dates, or any rare-but-critical personal events that happen months or years from now.</p>
