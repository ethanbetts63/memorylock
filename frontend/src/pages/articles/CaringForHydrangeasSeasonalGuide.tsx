...
const CaringForHydrangeasSeasonalGuide = () => {
  const articleDetails = {
    ...
    url: "https://www.futurereminder.app/articles/caring-for-hydrangeas-seasonal-guide",
    ogImage: "/static/og-images/og-caring-for-hydrangeas-seasonal-guide.webp",
    ...
    <>
      ...
      >
        <div className="text-lg text-primary-foreground">
          ...
          <p className="mb-6">One of the most common mistakes with hydrangea care is timing — people plan to prune, feed or protect their hydrangeas, then life gets in the way and the window closes. You probably saw this coming. FutureReminder exists to solve that problem: our <Link to="/articles/best-free-reminder-apps" className="font-bold text-white underline hover:text-primary">free tier</Link> is perfect for these sorts of gardening reminder needs. Why not just use your calender app? You definitely could. But a single notification is easy to miss. And what if you change phones? We use a notification hierarchy. We’ll start with <Link to="/articles/best-email-reminder-apps" className="font-bold text-white underline hover:text-primary">emails</Link>, then we’ll send you <Link to="/articles/best-text-message-reminder-apps" className="font-bold text-white underline hover:text-primary">texts</Link>. And we’ll keep trying to reach out until you acknowledge us. So that’s the pitch, nothing too complicated. We’d love for you to give it a try. And so would your hydrangeas’s. If you're interested checkout our homepage <Link to="/" className="font-bold text-white underline hover:text-primary">here</Link>.</p>
        </div>
      </ArticleLayout>
